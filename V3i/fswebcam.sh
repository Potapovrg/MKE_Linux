...
media-ctl --set-v4l2 '"ov2640 0-0030":0[fmt:YUYV8_2X8/${res}]' 
...
ffmpeg -hide_banner -f v4l2 -framerate 2 -video_size $res -i /dev/video0 \
-vcodec mpeg4 -q:v 2 -r 2 -f rtp_mpegts  rtp://192.168.111.1:8888
